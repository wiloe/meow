...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" --git-dir=.git show-ref "b5ddc9741061343740d85d636d782ed3e07cf7be"
  WORKING_DIRECTORY "C:/Users/golde/source/repos/meow/build/_deps/fontstash-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: b5ddc9741061343740d85d636d782ed3e07cf7be")
    return()
  endif()
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/golde/source/repos/meow/build/_deps/fontstash-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/golde/source/repos/meow/build/_deps/fontstash-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
